...
Page({
  ...
  onStep: function (e) {
    var that = this;
    if (that.data.true_name == "" || that.data.card == "" || that.data.card_images == "../images/upload-img.png" || that.data.card_images1 == "../images/upload-img.png" || that.data.logo=="../images/upload-img.png"){
      wx.showToast({
        title: '请完整填写信息',
        icon: 'loading',
        duration: 1000
